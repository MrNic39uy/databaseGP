...
CREATE TABLE `cooler` (
  ...
  `cooler_size` int NOT NULL,
  PRIMARY KEY (`Cooler_id`),
  CONSTRAINT `cooler_ibfk_1` FOREIGN KEY (`Cooler_id`) REFERENCES `product` (`product_id`)
...
INSERT INTO `cooler` VALUES (1,360),(2,360),(3,360),(4,360),(5,240),(6,240),(7,360),(8,360),(9,360),(10,360);
